...
import imgPark from "../../assets/backgrounds/park.png"; // Ensure this matches your file path
  ...
  return (
    <footer className="relative bg-[#05070D] border-t border-white/5 pt-20 pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        {/* TOP ROW: Trust Metrics (Replaces Fake Logos) */}
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <div className="relative flex bg-[#05070D] rounded-xl border border-white/10 overflow-hidden">
                ...
                />
                <button className="px-4 text-sm font-bold text-rose-400 hover:text-rose-300 transition-colors">
                  Join
                </button>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button
            onClick={scrollToTop}
            className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:bg-rose-500 hover:text-white hover:border-rose-500 transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(225,29,72,0.5)] group hover:-translate-y-1"
          >
