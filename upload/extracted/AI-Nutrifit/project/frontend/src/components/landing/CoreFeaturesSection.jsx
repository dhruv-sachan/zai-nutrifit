...
// UPDATE: Import Framer Motion for the roll-in entrance animation
import { motion } from "framer-motion";

import imgNutrition from "../../assets/features/feature-nutrition.jpg";
import imgBmi from "../../assets/features/feature-bmi.jpg";
import imgCalorie from "../../assets/features/feature-calorie.jpg";
import imgFitness from "../../assets/features/feature-fitness.jpg";
import imgAi from "../../assets/features/feature-ai.jpg";
import imgProgress from "../../assets/features/feature-progress.jpg";
...
const CoreFeaturesSection = () => {
  ...
  // UPDATE: Framer Motion variants for the staggered roll-in effect
  const containerVariants = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
      transition: { staggerChildren: 0.15 }, // Delays each card slightly for a cascading effect
    },
  };
  ...
  return (
    <section className="py-32 bg-slate-50 flex items-center justify-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
        ...
        {/* UPDATE: Wrapped the grid in a motion.div to control the scroll reveal */}
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, margin: "-100px" }} // Triggers slightly before they scroll into full view
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16"
        >
          {coreFeatures.map((feature) => (
            // UPDATE: Changed to motion.div, added transform-gpu, and optimized specific transitions instead of transition-all
            <motion.div
            ...
            >
              <div className="absolute inset-0 z-0">
                {/* UPDATE: Replaced transition-transform with transform-gpu optimization */}
                <img
                  src={feature.image}
                  alt={feature.title}
              ...
              {/* UPDATE: Switched to transition-opacity to prevent blur recalculation lag */}
              <div className="absolute inset-0 bg-[#0B1120]/90 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20 p-8 flex flex-col justify-center will-change-opacity">
                {/* UPDATE: Specific transform transition for the sliding text */}
