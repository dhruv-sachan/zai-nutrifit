  ...
  return (
    <div className="space-y-8 animate-fadeIn text-slate-800">
      ...
      {syncingStatus === "synced" && (
        <div className="p-4 bg-linear-to-r from-emerald-500/10 via-teal-500/5 to-transparent border border-emerald-100 rounded-2xl flex items-center gap-3 text-sm font-bold text-emerald-800 animate-fadeIn">
                        ...
                        <div className="px-4 pb-5 pt-1 border-t border-slate-100 space-y-4 animate-fadeIn text-sm font-medium">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <p className="text-slate-600 leading-relaxed pl-5 bg-rose-50/20 border-l-2 border-rose-500 py-1 rounded-r-md">
                              {exercise.avoid || "No specific contraindications."}
                            </p>
                          </div>
                        </div>
                      )}
