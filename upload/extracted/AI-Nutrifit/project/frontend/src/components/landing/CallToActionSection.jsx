  ...
  return (
    <section className="relative py-24 overflow-hidden bg-[#05070D] border-t border-rose-900/30">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        ...
        <a
          href="/login"
          className="w-max px-8 py-4 rounded-xl font-bold text-white shadow-[0_0_40px_rgba(225,29,72,0.3)] bg-gradient-to-r from-red-600 via-rose-500 to-fuchsia-600 hover:from-red-500 hover:via-rose-400 hover:to-fuchsia-500 transition-all duration-300 flex items-center justify-center gap-3 mx-auto group"
        >
          Get Started Free
