...
export default function AICopilotTab({ user }: { user: SafeUser | null }) {
  ...
  return (
    <div className="bg-white border border-slate-200/60 rounded-3xl h-[36rem] shadow-xl shadow-slate-200/10 flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-emerald-50/5 nf-scroll">
      ...
      <div className="px-6 py-2 bg-slate-50/50 border-t border-slate-100 flex gap-2 overflow-x-auto shrink-0 nf-scroll">
        <button
          onClick={() =>
            handleSendMessage(
